...
type CreateHotelHandlerFunc func(CreateHotelParams) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateHotelHandlerFunc) Handle(params CreateHotelParams) middleware.Responder {
	return fn(params)
}

// CreateHotelHandler interface for that can handle valid create hotel params
type CreateHotelHandler interface {
	Handle(CreateHotelParams) middleware.Responder
}
...
/*
	CreateHotel swagger:route POST /hotel createHotel
