...
func (o *GetBookingParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	rBookingID, rhkBookingID, _ := route.Params.GetOK("bookingID")
...
func (o *GetBookingParams) bindBookingID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if err != nil {
		return errors.InvalidType("bookingID", "path", "int64", raw)
	}
	o.BookingID = value
