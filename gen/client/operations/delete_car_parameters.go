...
// WithCarID adds the carID to the delete car params
func (o *DeleteCarParams) WithCarID(carID int64) *DeleteCarParams {
	o.SetCarID(carID)
	return o
}

// SetCarID adds the carId to the delete car params
func (o *DeleteCarParams) SetCarID(carID int64) {
	o.CarID = carID
}
