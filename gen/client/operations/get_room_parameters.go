...
// WithDefaults hydrates default values in the get room params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetRoomParams) WithDefaults() *GetRoomParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get room params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetRoomParams) SetDefaults() {
...
func (o *GetRoomParams) WithRoomID(roomID int64) *GetRoomParams {
	o.SetRoomID(roomID)
	return o
}

// SetRoomID adds the roomId to the get room params
func (o *GetRoomParams) SetRoomID(roomID int64) {
	o.RoomID = roomID
}
