...
func (o *DeleteUserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /user/{userID}] DeleteUser", response, response.Code())
	}
}
...
func (o *DeleteUserNoContent) Error() string {
	return fmt.Sprintf("[DELETE /user/{userID}][%d] deleteUserNoContent ", 204)
}
...
func (o *DeleteUserNotFound) Error() string {
	return fmt.Sprintf("[DELETE /user/{userID}][%d] deleteUserNotFound ", 404)
}
...
func (o *DeleteUserInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /user/{userID}][%d] deleteUserInternalServerError ", 500)
}
